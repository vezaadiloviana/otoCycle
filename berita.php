    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto fw-normal navbar-center">
          <li class="nav-item">
            <a class="nav-link active fw-bold text-white" aria-current="page" href="#">Berita</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md">
          <p><br></p>
          <p><br></p>
          <p class="fs-1 fw-bold lh-sm mt-3 text-white">Berita</p>
          <div class="col-10">
            <p class="lh-sm mt-3 text-white" style="text-align: justify;">Beranda > Berita</p>
          </div>
        </div>
...
<section id="recent">
    <div class="container">
      ...
      <?php
          foreach($data_berita as $index => $value){
      ?>
        <div class="col-md-4 mb-4">
          <div class="card">
            <a href="#"><img src="assets/<?php echo $value['foto_berita'] ?>" class="card-img-top" alt="card blog 1" /></a>
            <div class="card-body">
              <h5 class="card-title"><?php echo $value['judul_berita'] ?></h5>
              <p class="card-text" style="text-indent: 0.5in; text-align: justify;"><?php echo $value['deskripsi_berita'] ?></p>
              <a href="isi_berita.php?id=<?php echo $value['id_berita']?>" class="text-dark">Learn more <i class="bi bi-arrow-right-circle"></i></a>
            </div>
          </div>
        </div>
       <?php
