<?php 
  include "koneksi.php";
  $id = $_GET["id"];
  $berita = "select * from berita where id_berita = $id ";
  $data_berita = $conn->query($berita)->fetch_assoc();
...
<body>
    ...
    <!-- About 1-->
    <section id="header_berita">
        <div class="container">
            <div class="row"></div>
            <div class="row justify-content-center">
                <div class="col-md">
                    <a href="berita.php"><img src="img/backarr.svg"></a>
                    <p><br></p>
                    <p><br></p>
                    <p class="fs-1 fw-bold lh-sm mt-3 text-white"><?= $data_berita["judul_berita"] ?></p>
                </div>
    ...
    <div class="mt-5">
        <img src="assets/<?php echo $data_berita['foto_berita'] ?>">
    </div>
    </div>
    <!-- foto -->
