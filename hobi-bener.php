<?php 
  include "koneksi.php";
  $id = $_GET["id"];
  $hobi = "select * from hobi where id_hobi = $id ";
  $data_hobi = $conn->query($hobi)->fetch_assoc();
...
<body>
    ...
    <!-- About 1-->
    <section id="header_hobi">
        <div class="container">
            <div class="row"></div>
            <div class="row justify-content-center">
                <div class="col-md">
                    <a href="hobby.php"><img src="img/backarr.svg"></a>
                    <p><br></p>
                    <p><br></p>
                    <p class="fs-1 fw-bold lh-sm mt-3 text-white"><?= $data_hobi["judul_hobi"] ?></p>
                </div>
    ...
    <div class="mt-5">
        <img src="assets/<?php echo $data_hobi['foto_hobi'] ?>">
    </div>
    </div>
    <!-- foto -->
