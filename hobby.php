...
<head>
  ...
  <style>
    #hobby1 {
    color: white;
    background-image: url("../img/hobby2.svg");
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light shadow-sm fixed-top">
    <div class="container">
      <a class="navbar-brand text-white mb-0 h1" href="index.html">OtoCycle</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto fw-normal navbar-center">
          ...
          <li class="nav-item">
            <a class="nav-link text-white fw-bold" href="hobby.php">Hobby</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md">
          <p><br></p>
          <p><br></p>
          <p class="fs-1 fw-bold lh-sm mt-3 text-white">Hobby</p>
          <div class="col-10">
            <p class="lh-sm mt-3 text-white" style="text-align: justify;">Beranda > Hobby</p>
          </div>
        </div>
...
<section id="recent">
    <div class="container">
      ...
      <?php
          foreach($data_hobi as $index => $value){
      ?>
        <div class="col-md-4 mb-4">
          <div class="card">
            <a href="#"><img src="assets/<?php echo $value['foto_hobi'] ?>" class="card-img-top" alt="card blog 1" /></a>
            <div class="card-body">
              <h5 class="card-title"><?php echo $value['judul_hobi'] ?></h5>
              <p class="card-text" style="text-indent: 0.5in; text-align: justify;"><?php echo $value['deskripsi_hobi'] ?></p>
              <a href="hobi-bener.php?id=<?php echo $value['id_hobi']?>" class="text-dark">Learn more <i class="bi bi-arrow-right-circle"></i></a>
            </div>
          </div>
        </div>
       <?php
